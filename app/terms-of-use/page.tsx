...
export const metadata: Metadata = {
  title: "Terms of Use",
  description:
    "Read the basic terms for using ToolSpark and its free online tools.",
};
    ...
    <main className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-5 py-10 sm:px-8">
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-6 shadow-sm">
        <SectionTitle
          ...
          title="Simple rules for using ToolSpark"
      ...
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700">
          You can use ToolSpark tools for personal and professional tasks. Do
      ...
      <section className="rounded-2xl border border-slate-200 bg-white/95 p-6 shadow-sm">
        ...
        <p className="mt-3 text-sm leading-7 text-slate-700">
          Continued use of ToolSpark means you accept the latest version of these
          terms.
        </p>
      </section>
